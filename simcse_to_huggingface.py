...
def main():
    ...
    parser.add_argument("--path", type=str, default='result/unsup-simcse-bert-base-uncased', help="Path of SimCSE checkpoint folder")
    ...
    torch.save(new_state_dict, os.path.join(args.path, "new_pytorch_model.bin"))
    ...
    json.dump(config, open(os.path.join(args.path, "new_config.json"), "w"), indent=2)
